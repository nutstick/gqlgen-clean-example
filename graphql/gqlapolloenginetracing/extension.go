...
type treeNode struct {
	node     *executionSpan `json:"node"`
	children treeChildren   `json:"children"`
}

type treeChildren map[interface{}]*treeNode

func (m treeChildren) MarshalJSON() ([]byte, error) {
	tmp := map[string]*treeNode{}
